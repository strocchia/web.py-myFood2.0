...
# coding: utf-8
def returned_data_bootstrap_jquery (pyDates, lunches, dinners, miscs, CSVrows, Ltot_thisMonth, Dtot_thisMonth, Mtot_thisMonth, Ltot_All, Dtot_All, Mtot_All):
    __lineoffset__ = -4
    loop = ForLoop()
    self = TemplateResult(); extend_ = self.extend
    extend_([u'\n'])
    ...
    extend_([u'                        var Jdates = [];\n'])
    extend_([u'                        \n'])
    extend_([u'            for(var i = 0; i < jQuery(', escape_(pyDates, True), u').length; i+=1)\n'])
    extend_([u'            {\n'])
    extend_([u'                                Jdates.push(new Date(jQuery(', escape_(pyDates, True), u')[i]));\n'])
    extend_([u'                                if(jQuery(', escape_(lunches, True), u').length > 0)\n'])
    extend_([u'                                {\n'])
    extend_([u'                                        y1.push([Jdates[i], jQuery(', escape_(lunches, True), u')[i]]);\n'])
    extend_([u'                                }\n'])
    extend_([u'                                if(jQuery(', escape_(dinners, True), u').length > 0)\n'])
    extend_([u'                                {\n'])
    extend_([u'                                        y2.push([Jdates[i], jQuery(', escape_(dinners, True), u')[i]]);\n'])
    extend_([u'                                }\n'])
    extend_([u'                                if(jQuery(', escape_(miscs, True), u').length > 0)\n'])
    extend_([u'                                {\n'])
    extend_([u'                                        y3.push([Jdates[i], jQuery(', escape_(miscs, True), u')[i]]);\n'])
    extend_([u'                                }\n'])
    extend_([u'                        }\n'])
