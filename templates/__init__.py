...
def init_form_bootstrap (clearMessage):
    ...
    extend_([u'                <input type="tel" name="LDM" class="form-control" placeholder="Enter money spent for particular meal">\n'])
    extend_([u'            </div>\n'])
    extend_([u'            <div class="form-group">\n'])
    ...
    extend_([u'            <br>-- Clear: clears your entire database\n'])
    extend_([u'            <br>--- Undo: clears the last entry for a particular chosen meal type\n'])
    extend_([u'            <!--br></br-->\n'])
    extend_([u'            <br> After entering data, go to <a href="/getcsv">myfood2dot0.appspot.com/getcsv</a> to retrieve a personalized CSV file of your meal expenses.\n'])
    extend_([u'\n'])
    extend_([u'            <br></br>\n'])
    extend_([u'            <br></br>\n'])
    extend_([u'            <font size="2">&copy; <i>Scott Trocchia (2013)</i> </font>\n'])
