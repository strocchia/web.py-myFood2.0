...
def init_form_bootstrap_jquery (clearFlag):
    ...
    extend_([u'                        <br>Note that you must enter and remember your user name before performing any of the following operations:\n'])
...
def returned_data_bootstrap_jquery (py_L_Dates, py_D_Dates, py_M_Dates, lunches, dinners, miscs, CSVrows, Ltot_thisMonth, Dtot_thisMonth, Mtot_thisMonth, Ltot_All, Dtot_All, Mtot_All):
    ...
    extend_([u'                        var y3 = [];\n'])
    extend_([u'\n'])
    extend_([u"                        // THE THING I WAS MISSING BEFORE (TO CONVERT A STRING DATE FROM PYTHON TO A RECOGNIZABLE DATE IN JAVASCRIPT) WAS ':", escape_(' ... I DIDN', True), u'T KNOW I HAD TO PUT THE COLON!!!\n'])
    extend_([u'                        for(var i = 0; i < jQuery(', escape_(lunches, True), u').length; i+=1)\n'])
    extend_([u'                        {\n'])
    extend_([u'                                var a = new Date(jQuery(', escape_(py_L_Dates, False), u')[i]);\n'])
    extend_([u'                                y1.push([a, jQuery(', escape_(lunches, True), u')[i]]);\n'])
    extend_([u'                        }\n'])
    extend_([u'                        \n'])
    extend_([u'                        \n'])
    extend_([u'                        for(var i = 0; i < jQuery(', escape_(dinners, True), u').length; i+=1)\n'])
    extend_([u'                        {\n'])
    extend_([u'                                var b = new Date(jQuery(', escape_(py_D_Dates, False), u')[i]);\n'])
    extend_([u'                                y2.push([b, jQuery(', escape_(dinners, True), u')[i]]);\n'])
    extend_([u'                        }\n'])
    extend_([u'                        \n'])
    extend_([u'                        for(var i = 0; i < jQuery(', escape_(miscs, True), u').length; i+=1)\n'])
    extend_([u'                        {\n'])
    extend_([u'                                var c = new Date(jQuery(', escape_(py_M_Dates, False), u')[i]);\n'])
    extend_([u'                                y3.push([c, jQuery(', escape_(miscs, True), u')[i]]);\n'])
    extend_([u'                        }\n'])
    extend_([u'                        \n'])
    extend_([u'                        // debugging only\n'])
    extend_([u"                        //jQuery('#text1').val([y1]);\n"])
    extend_([u"                        //jQuery('#text2').val(b);\n"])
    extend_([u"                        //jQuery('#text3').val();\n"])
    extend_([u'\n'])
